...
class _$CountryModelImpl implements _CountryModel {
  _$CountryModelImpl(
      {this.name, this.native, this.capital, this.emoji, this.currency});
  ...
  @override
  String toString() {
    return 'CountryModel(name: $name, native: $native, capital: $capital, emoji: $emoji, currency: $currency)';
  }
  ...
  @override
  int get hashCode =>
      Object.hash(runtimeType, name, native, capital, emoji, currency);
